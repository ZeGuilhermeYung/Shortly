...
import { validateUrlSchema } from "../middlewares/schemasMiddlewares.js";
import { nonRepeatedUrlValidation, userHasUrlValidation } from "../middlewares/urlsMiddlewares.js";

const urlsRouter = express.Router();
urlsRouter.post("/urls/shorten", authValidation, validateUrlSchema, nonRepeatedUrlValidation, shortUrl);
